 ...
 */
final class Version20220506224617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ideas (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, status_id INT DEFAULT NULL, category_id INT DEFAULT NULL, type_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, date DATETIME NOT NULL, photo LONGTEXT DEFAULT NULL, href LONGTEXT DEFAULT NULL, INDEX IDX_1DB2F1DEA76ED395 (user_id), INDEX IDX_1DB2F1DE6BF700BD (status_id), INDEX IDX_1DB2F1DE12469DE2 (category_id), INDEX IDX_1DB2F1DEC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
